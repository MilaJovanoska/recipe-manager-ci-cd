            ...
            <CardContent className="recipe-card-content">
                <Stack spacing={2}>
                    ...
                    <Box className="recipe-card-chips">
                        <Chip label={categoryName} size="small" className="recipe-card-chip-category" />
                        <Chip label={recipe.difficulty} size="small" className="recipe-card-chip" />
                        <Chip label={`${recipe.preparationTime} min`} size="small" className="recipe-card-chip" />
                        <Chip label={`${recipe.servings} servings`} size="small" className="recipe-card-chip" />
                    </Box>
                </Stack>
            </CardContent>
